...
public class StatisticsMG {
    ...
    public void openMinigamesMenu(Player p) {
        ...
        swLore.add("");
        swLore.add("§eZabiti: §7" +  Main.getInstance().fetchData().getSkyWarsKills(p.getUniqueId()));
        swLore.add("§eSmrti: §7" +  Main.getInstance().fetchData().getSkyWarsDeaths(p.getUniqueId()));
        swLore.add("§eVitezstvi: §7" +  Main.getInstance().fetchData().getSkyWarsWins(p.getUniqueId()));
        swLore.add("§eOdehrano her: §7"  + Main.getInstance().fetchData().getSkyWarsPlayed(p.getUniqueId()));
        swLore.add("");
