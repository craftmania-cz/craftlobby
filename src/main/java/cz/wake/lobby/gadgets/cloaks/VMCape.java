...
public class VMCape {
    ...
    public static final HashMap<String, Integer> listCloaks = new HashMap();
    boolean x = true;
    boolean y = false;
    int particles;
    ...
    public void activate(Player p) {
        ...
        if (!listCloaks.containsKey(p.getName())) {
            ...
            listCloaks.put(p.getName(), Integer.valueOf(particles));
            p.closeInventory();
        }
