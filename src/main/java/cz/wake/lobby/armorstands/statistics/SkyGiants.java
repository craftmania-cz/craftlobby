...
public class SkyGiants {
    ...
    public static void spawn(Location loc, Player p){
        ...
        stand.setCustomName("§6§lTvoje SkyGiants");
        ...
        stand2.setCustomName("§7Vyhry: §f" + Main.getInstance().fetchData().getMiniGamesStats(p,"SkyGiants_stats", "Player","Victories"));
        ...
        stand3.setCustomName("§7Zabiti: §f" + Main.getInstance().fetchData().getMiniGamesStats(p,"SkyGiants_stats","Player","Kills"));
        ...
        stand4.setCustomName("§7Smrti: §f" + Main.getInstance().fetchData().getMiniGamesStats(p,"SkyGiants_stats","Player","Deaths"));
        ...
        stand5.setCustomName("§7Zabiti bosse: §f" + Main.getInstance().fetchData().getMiniGamesStats(p,"SkyGiants_stats","Player","BeastsSlain"));
        ...
        stand6.setCustomName("§7Odehrano: §f" + Main.getInstance().fetchData().getMiniGamesStats(p,"SkyGiants_stats","Player","GamesPlayed"));
        ...
        stand7.setCustomName("§7Zniceno teamu: §f" + Main.getInstance().fetchData().getMiniGamesStats(p,"SkyGiants_stats","Player","Shutdowns"));
