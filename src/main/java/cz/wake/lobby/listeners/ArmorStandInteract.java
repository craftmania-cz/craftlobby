...
public class ArmorStandInteract implements Listener {
    ...
    public void interact(PlayerInteractAtEntityEvent e) {
        ...
        if (e.getRightClicked() instanceof ArmorStand) {
            ...
            if (e.getRightClicked().hasMetadata("vanilla2")) {
                Main.getInstance().getCraftBalancerManager().bypassConnect(p, "vanilla2");
            }
            ...
            if (e.getRightClicked().hasMetadata("Halloween")) {
                Main.getInstance().getCraftBalancerManager().connectPlayer(p, "halloween-games");
            }
            e.setCancelled(true);
