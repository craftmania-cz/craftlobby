...
public class ServerSelectorGUI implements InventoryProvider {
    ...
    public void init(Player player, InventoryContents contents) {
        ...
        contents.set(0, 3, ClickableItem.of(new ItemBuilder(Material.HEART_OF_THE_SEA)
                .setName("§f쇯") // OneBlock
        ...
        contents.set(1, 1, ClickableItem.of(new ItemBuilder(Material.LAVA_BUCKET)
                .setName("§f⼫") // Creative
        ...
        contents.set(1, 2, ClickableItem.of(new ItemBuilder(Material.IRON_NUGGET).setCustomModelData(100014)
                .setName("§f⼤") // Vanilla
                .setLore("§8Doporučená verze: §f1.19+", "", "§8• §7Ochrana chunků: Lands", "§8• §7Server bez ekonomiky / shopů", "§8• §7Questy & challange", "", ChatColor.of("#FFD39B") + "Klikni pro připojení")
                .hideAllFlags()
                .build(), (clickEvent) -> Main.getInstance().sendToServer(player, "vanilla")));

        contents.set(0, 2, ClickableItem.of(new ItemBuilder(Material.NETHERITE_SWORD)
