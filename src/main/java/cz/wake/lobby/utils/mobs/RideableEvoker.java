...
public class RideableEvoker extends EntityEvoker {

    public RideableEvoker(World world) {
        super(world);
    }
    ...
    public static Evoker spawn(Location location) {
        World mcWorld = (World) ((CraftWorld) location.getWorld()).getHandle();

        RideableEvoker customEntity = new RideableEvoker(mcWorld);
        ...
        return (CraftEvoker) customEntity.getBukkitEntity();
    }
}
