...
public class RideableGuardianElder extends EntityGuardianElder {

    public RideableGuardianElder(World world) {
        super(world);
    }
    ...
    public static ElderGuardian spawn(Location location) {
        World mcWorld = (World) ((CraftWorld) location.getWorld()).getHandle();

        RideableGuardianElder customEntity = new RideableGuardianElder(mcWorld);
