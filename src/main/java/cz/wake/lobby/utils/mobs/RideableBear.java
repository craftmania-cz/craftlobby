...
public class RideableBear extends EntityPolarBear{

    protected Field FIELD_JUMP = null;

    public RideableBear(World world) {
        super(world);
    ...
    public static PolarBear spawn(Location location) {
        World mcWorld = (World) ((CraftWorld) location.getWorld()).getHandle();

        RideableBear customEntity = new RideableBear(mcWorld);
        ...
        return (CraftPolarBear) customEntity.getBukkitEntity();
    }
}
