...
public class RideableWitherSkeleton extends EntitySkeletonWither {

    public RideableWitherSkeleton(World world) {
        super(world);
    }
    ...
    public static WitherSkeleton spawn(Location location) {
        World mcWorld = (World) ((CraftWorld) location.getWorld()).getHandle();

        RideableWitherSkeleton customEntity = new RideableWitherSkeleton(mcWorld);
        ...
        return (CraftWitherSkeleton) customEntity.getBukkitEntity();
    }
}
*/
