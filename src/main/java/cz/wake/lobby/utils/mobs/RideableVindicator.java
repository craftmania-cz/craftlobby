...
public class RideableVindicator extends EntityVindicator {

    public RideableVindicator(World world) {
        super(world);
    }
    ...
    public static Vindicator spawn(Location location) {
        World mcWorld = (World) ((CraftWorld) location.getWorld()).getHandle();

        RideableVindicator customEntity = new RideableVindicator(mcWorld);
