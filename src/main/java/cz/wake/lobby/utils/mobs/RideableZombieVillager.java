...
public class RideableZombieVillager extends EntityZombieVillager {

    public RideableZombieVillager(World world) {
        super(world);
    }
    ...
    public static ZombieVillager spawn(Location location) {
        World mcWorld = (World) ((CraftWorld) location.getWorld()).getHandle();

        RideableZombieVillager customEntity = new RideableZombieVillager(mcWorld);
        ...
        return (CraftVillagerZombie) customEntity.getBukkitEntity();
    }
}
*/
