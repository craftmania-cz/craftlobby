...
public class RideableLlama extends EntityLlama {
    ...
    public static Llama spawn(Location location) {
        World mcWorld = (World) ((CraftWorld) location.getWorld()).getHandle();

        RideableLlama customEntity = new RideableLlama(mcWorld);
        ...
        return (CraftLlama) customEntity.getBukkitEntity();
    }
}
